public class SwitchStatements {
    public static void main(String[] args) {
        ...
        switch (weather) {
            case "snowy":
            System.out.println("The temperature is snowy");
                break;
                
            case "cloudy":
                System.out.println("The temperature is cloudy");
                break;

            case "rainy":
                System.out.println("The temperature is rainy");
                break;

            case "sunny":
                System.out.println("The temperature is sunny");
                break;
