...
public class NextLineTrap {
    public static void main(String[] args) {
        ...
        System.out.print("\nEnter a greeting: ");
        scanner.nextLine();//Throwayway nextLine to be wasted on rmpty spacce
        ...
        System.out.println("Populations: City 1 - " + city1Population + "\n, City 2 - " + city2Population + "\n, City 3 - " + city3Population + "\n");

        System.out.print("\nEnter the name of the most populous city: ");
        scanner.nextLine();// Throwayway nextLine to be wasted on rmpty space
        String cityName = scanner.nextLine();

        System.out.println("\n Most populous city: " + cityName);
        ...
        System.out.println("Colors: 1 - " + color1 + "\n, 2 - " + color2 + "\n, 3 - " + color3 +"\n");

        System.out.print("\nEnter your favorite color combination: ");
        scanner.nextLine();// Throwayway nextLine to be wasted on rmpty spacce
        String colorCombination = scanner.nextLine();
        System.out.println("\nFavorite color combination: " + colorCombination);
